...
// import { createDeferred, convertHexStrToUint } from "../discovery/utils";
// import { bytesToInt, bytesToUnPrefixedHex, equalsBytes } from "../../utils";

// import { Peer } from "./peer.js";

// import type { DiscoveryProtocol as DPT } from "../discovery/core/discovery-protocol.module.js";
...
//   constructor(privateKey: Uint8Array, nodeId: string, options: RLPxOptions) {
//     this.events = new EventEmitter();
//     this._privateKey = privateKey;
//     this.id = convertHexStrToUint(nodeId);
...
//       ? options.clientId
//       : convertHexStrToUint(`arcanum/${os.platform()}-${os.arch()}/nodejs`);
...
//   private _onConnect(socket: net.Socket, peerId: Uint8Array | null) {
